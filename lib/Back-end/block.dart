...
class Theme_overall {
  ...
  Theme_overall(this.theme, this.small, this.medium, this.large);
}
...
class ThemeBloc extends Bloc<ThemeEvent, Theme_overall> {
  ...
  Theme_overall blue = Theme_overall(
    ThemeData(
        ...
        textTheme: TextTheme(
          headline1: TextStyle(
              fontSize: 22.0, color: Colors.white, fontFamily: "Heading1"),
          headline2: TextStyle(
            fontSize: 16.0,
            color: Colors.white,
          ),
      ...
      ThemeData(
          ...
          textTheme: TextTheme(
            headline1: TextStyle(
                fontSize: 22.0, color: Colors.white, fontFamily: "Heading1"),
            headline2: TextStyle(
                fontSize: 16.0, color: Colors.white, fontFamily: "Heading1"),
            headline3: TextStyle(
              fontSize: 12.0,
              color: Colors.grey,
            ),
  ...
  //Return String
  String stringValue = prefs.getString(themekey);
  if(stringValue == null)
  this.add(ThemeEvent.blue);
  else{
  stringValue = stringValue.substring(stringValue.lastIndexOf(".")+1,stringValue.length);
  switch(stringValue){
      case 'yellow' :  this.add(ThemeEvent.yellow); break;
      case 'blue' : this.add(ThemeEvent.blue); break;
      case 'pink' : this.add(ThemeEvent.pink); break;
      case 'green' : this.add(ThemeEvent.green); break;
      case 'purple' : this.add(ThemeEvent.purple); break;
      case 'grey' : this.add(ThemeEvent.grey); break;
  }
  }
  }
